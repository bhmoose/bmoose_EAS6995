...
for hidden_size in [100, 500]:
    for seq_length in [10, 25, 100]:
        for learning_rate in [0.001, 0.01, 0.1]:

            print('Starting HS = ' + str(hidden_size) + ', SL = ' + str(seq_length) + ', LR = ' + str(learning_rate))
            ...
            textfile = open('lstm_hyperparam_text_' + str(hidden_size) + '_' + str(seq_length) + '_' + str(learning_rate) + '.txt', 'w+')
            lossfile = open('lstm_hyperparam_loss_' + str(hidden_size) + '_' + str(seq_length) + '_' + str(learning_rate) + '.txt', 'w+')
